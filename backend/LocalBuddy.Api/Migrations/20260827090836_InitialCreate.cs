        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnlockedByPayment = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnlockedUserId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeasonStart = table.Column<DateOnly>(type: "date", nullable: true),
                    SeasonEnd = table.Column<DateOnly>(type: "date", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    OffersExperience = table.Column<bool>(type: "boolean", nullable: false),
                    OffersOvernight = table.Column<bool>(type: "boolean", nullable: false),
                    OvernightComplianceAck = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_InitiatorId_TargetId",
                table: "Matches",
                columns: new[] { "InitiatorId", "TargetId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_AuthorId_SubjectId",
                table: "Reviews",
